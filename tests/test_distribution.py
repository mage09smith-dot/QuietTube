...
class DistributionTests(unittest.TestCase):
 ...
 def test_version_is_consistent(self):
  ...
  self.assertIn(v,['1.2.0','1.3.0-exp.1','1.3.0-exp.2','1.3.0-exp.3','1.3.0-exp.4','1.3.0-exp.5','1.3.0-exp.6','1.3.0-exp.7','1.3.0-exp.8','1.3.0-exp.9','1.3.0-exp.10','1.3.0-exp.11','1.3.0-exp.12','1.3.0-exp.13','1.3.0-exp.14','1.3.0-exp.15','1.3.0-exp.16','1.3.0-exp.17'])
